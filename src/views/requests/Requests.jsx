...
export default function Requests() {
  const { isLoading, isRecurring, clientId, requestId, category, odataQuery, tabelData, errorMessage, handleStates, handleNavigate, ZoneSelect, SystemSelect, CategorySelect, RenderFindBtn, RenderRemoveIcon, RefreshButton, CancelButton } = useApiLogsStates("Request");
