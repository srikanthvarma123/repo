...
export default function Response() {
  const { isLoading, isRecurring, clientId, requestId, category, odataQuery, tabelData, errorMessage, handleStates, handleNavigate, ZoneSelect, CategorySelect, SystemSelect, RenderFindBtn, RenderRemoveIcon, RefreshButton, CancelButton } = useApiLogsStates("Response");
